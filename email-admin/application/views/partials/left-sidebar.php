    ...
    <ul class="sidebar-menu" id="nav-accordion">
      ...
      <li class="sub-menu">
        ...
        <ul class="sub" <?php var_dump(uri_string()); ?>>
          ...
          <li <?php echo uri_string() == "Emails/BankNewSeller" ? "class='active'" : ""; ?>><a href="<?php echo base_url('Emails/BankNewSeller'); ?>">Bank - Assign Seller</a></li>

          <li <?php echo uri_string() == "Emails/BankExistingSeller" ? "class='active'" : ""; ?>><a href="<?php echo base_url('Emails/BankExistingSeller'); ?>">Bank - Existing Seller</a></li>
          ...
          <li <?php echo uri_string() == "Emails/Homestarter" ? "class='active'" : ""; ?>><a href="<?php echo base_url('Emails/Homestarter'); ?>">Home Starter Inquiries</a></li>

          <li <?php echo uri_string() == "Emails/CountryClubShare" ? "class='active'" : ""; ?>><a href="<?php echo base_url('Emails/CountryClubShare'); ?>">Country Club Inquiries</a></li>
